...
exports.Z_HealthRecord = exports.Z_HealthRecordUpdate = void 0;
const zod_1 = require("zod");
const healthRecordService_1 = require("./healthRecordService");
const Z_Symptoms = zod_1.z.object({
    name: zod_1.z
        .string()
        .trim()
    ...
    startDate: zod_1.z.date().max(new Date(), "Start date cannot be in the future").optional(),
    duration: zod_1.z
        .string()
        .optional()
        .refine((val) => !val || /^\d+\s*(days?|weeks?|months?|years?)$/i.test(val), "Duration must be in format: '5 days', '2 weeks', '1 month', etc."),
});
const Z_MedicalConsultation = zod_1.z.object({
    consultant: zod_1.z
        .string()
        .trim()
...
exports.Z_HealthRecordUpdate = zod_1.z.object({
    description: zod_1.z
        .string()
        .trim()
        ...
        .optional(),
    symptoms: zod_1.z.array(Z_Symptoms).default([]),
    ...
    medicalConsultations: zod_1.z.array(Z_MedicalConsultation).default([]),
    createdAt: zod_1.z.date().optional(),
    updatedAt: zod_1.z.date().optional(),
});
exports.Z_HealthRecord = zod_1.z.object({
    user: zod_1.z
        .string()
        .trim()
    ...
    description: zod_1.z
        ...
        .min(2, (0, healthRecordService_1.minValidationMessage)("Description", 2))
        .max(healthRecordService_1.MAX_CHAR_LONG, (0, healthRecordService_1.maxValidationMessage)("Description", healthRecordService_1.MAX_CHAR_LONG)),
    symptoms: zod_1.z.array(Z_Symptoms).min(1, "At least one symptom is required"),
    ...
    updates: zod_1.z.array(exports.Z_HealthRecordUpdate).default([]),
    createdAt: zod_1.z.date().optional(),
    updatedAt: zod_1.z.date().optional(),
});
